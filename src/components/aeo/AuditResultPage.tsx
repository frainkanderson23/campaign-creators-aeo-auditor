...
function ClaudeIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M4.71 6.72c2.23-3.86 7.15-5.19 11.01-2.96a8.03 8.03 0 0 1 2.96 11.01c-2.23 3.86-7.15 5.19-11.01 2.96A8.03 8.03 0 0 1 4.71 6.72z" fill="currentColor" opacity="0.35"/>
      <path d="M15.44 8.27l-3.02 7.44h-1.88L7.8 8.27h2.04l2.17 5.7 2.2-5.7h1.23z" fill="currentColor"/>
    </svg>
  );
}

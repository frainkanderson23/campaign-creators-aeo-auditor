...
function ClaudeIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M16.1 2.96a1.15 1.15 0 0 0-2.17 0L12 8.86l-5.9-5.9a1.15 1.15 0 0 0-2.17.77L6.1 12l-5.9 1.93a1.15 1.15 0 0 0 0 2.17L6.1 18.1l-2.17 5.9a1.15 1.15 0 0 0 2.17.77l5.9-5.9 1.93 5.9a1.15 1.15 0 0 0 2.17 0L18.1 18.1l5.9 2.17a1.15 1.15 0 0 0 .77-2.17L18.1 12l5.9-5.9a1.15 1.15 0 0 0-.77-2.17L18.1 6.1l-2-3.14z" fill="currentColor"/>
    </svg>
  );
}
...
export default function AuditResultPage({ requestData, auditData }: Props) {
  ...
  const engines = [
    { name: 'ChatGPT', bg: '#10A37F', icon: <OpenAIIcon />, probe: openaiProbe },
    { name: 'Perplexity', bg: '#20808D', icon: <PerplexityIcon />, probe: perplexityProbe },
    { name: 'Google AI', bg: 'linear-gradient(135deg,#4285F4,#34A853)', icon: <GoogleAIIcon />, probe: googleProbe },
    { name: 'Claude', bg: '#D97757', icon: <ClaudeIcon />, probe: claudeProbe },
  ];
